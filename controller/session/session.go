...
// @Tags         AI 聊天
// @Produce      json
// @Success      200 {object} GetUserSessionsResponse
...
// CreateSessionAndSendMessage 创建会话并发送消息（非流式）
// @Summary      创建会话并发送消息
// @Description  创建新会话并发送用户消息，返回 AI 完整回答
// @Tags         AI 聊天
// @Accept       json
// @Produce      json
// @Param        request body CreateSessionAndSendMessageRequest true "用户问题和模型类型"
// @Success      200 {object} CreateSessionAndSendMessageResponse
...
// ChatSend 发送消息（非流式）
// @Summary      发送消息
// @Description  在已有会话中发送用户消息，返回 AI 完整回答
// @Tags         AI 聊天
// @Accept       json
// @Produce      json
// @Param        request body ChatSendRequest true "用户问题、模型类型和会话ID"
// @Success      200 {object} ChatSendResponse
...
// @Accept       json
// @Produce      json
// @Param        request body ChatHistoryRequest true "会话ID"
